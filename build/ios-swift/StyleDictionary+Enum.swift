...
public enum StyleDictionaryEnum {
    ...
    public static let vdsButtonLargeFontSize = 30px
    ...
    public static let vdsColorPGradient2 = linear-gradient(45deg, #0064ff 0%, #0037c5 100%)
    ...
    public static let vdsFontSize0 = 30px
