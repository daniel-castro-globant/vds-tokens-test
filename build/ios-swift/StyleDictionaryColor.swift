...
public enum StyleDictionaryColor {
    ...
    public static let colorCelestialSphere = UIColor(red: 0.400, green: 0.400, blue: 0.400, alpha: 1)
    public static let colorPDark = UIColor(red: 0.000, green: 0.216, blue: 0.773, alpha: 1)
